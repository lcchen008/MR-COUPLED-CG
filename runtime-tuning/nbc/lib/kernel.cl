			...
			)
{
	...
	const unsigned int cpu_blocks = CPU_GLOBAL_THREADS/CPU_LOCAL_THREADS;
	const unsigned int gpu_blocks = GPU_GLOBAL_THREADS/GPU_LOCAL_THREADS;
	const unsigned int num_blocks = cpu_blocks + gpu_blocks;
