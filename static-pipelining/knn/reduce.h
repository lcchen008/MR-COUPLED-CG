...
bool equal_local_and_local(__local void *key1, unsigned size1, __local void *key2, unsigned size2)
{
	if(size1!=size2)
		return false;
	__local char *k1 = (__local char *)key1;
...
void reduce_global_to_local(__local void *value1, unsigned short value1_size, __global void *value2, unsigned short value2_size)
{
	int temp = *(__local int *)value1 + *(__global int *)value2;
	copyVal_private_to_local(value1, &temp, sizeof(int));
}
...
void reduce_local_to_local(__local void *value1, unsigned short value1_size, __local void *value2, unsigned short value2_size)
{
	
}

void reduce_local_to_cpu(__global void *value1, unsigned short value1_size, __local void *value2, unsigned short value2_size)
{
