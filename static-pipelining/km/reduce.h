...
void reduce_local_to_global(__global void *value1, unsigned short value1_size, __local void *value2, unsigned short value2_size)
{
	...
	unsigned int num_points1 = ((__global float *)value1)[3];
	unsigned int num_points2 = ((__local float *)value2)[3];
	float dist1 = ((__global float *)value1)[4];
...
{
	//printf("reducing... ****");
	unsigned int num_points1 = ((__local float *)value1)[3];
	unsigned int num_points2 = ((float *)value2)[3];
...
void reduce_global_to_local(__local void *value1, unsigned short value1_size, __global void *value2, unsigned short value2_size)
{
	...
	unsigned int total_points = num_points1 + num_points2;
	float temp[5];
	temp[0] = ((__local float *)value1)[0] + ((__global float *)value2)[0];
	temp[1] = ((__local float *)value1)[1] + ((__global float *)value2)[1];
	temp[2] = ((__local float *)value1)[2] + ((__global float *)value2)[2];
	temp[3] = total_points;
	temp[4] = dist1 + dist2;
